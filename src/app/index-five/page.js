...
export default function IndexFive(){
    return(
        <>
        <NavLight/>
        <section className="relative flex items-center w-full py-36 lg:h-screen bg-gray-900 dark:bg-slate-800 bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url('/images/bg/bg2.png')`}} id="home">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-800 md:p-8 p-6 lg:ms-10 z-10 relative">
                            ...
                            <form>
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        <Link href="" className="h-10 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-teal-500 text-white w-full">Free Trial</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
