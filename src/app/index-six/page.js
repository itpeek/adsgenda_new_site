        ...
        <section className="relative md:h-screen md:py-0 py-36 items-center overflow-hidden bg-gradient-to-t to-teal-600 via-teal-600/50 from-transparent" id="home">
            <div className="container relative">
                <div className="grid grid-cols-1 md:mt-48 mt-10 text-center">
                    ...
                    <span className="text-white font-medium">Looking for help? <Link href="" className="text-white underline">Get in touch with us</Link></span>

                    <div className="overflow-hidden mt-8">
                        <Image src='/images/home.png' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} alt=""/>
                    </div>
                </div>
            </div>
        </section>
